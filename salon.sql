...
INSERT INTO public.services VALUES (2, 'Dry');
...
SELECT pg_catalog.setval('public.appointments_appointment_id_seq', 56, true);
...
SELECT pg_catalog.setval('public.customers_customer_id_seq', 46, true);
